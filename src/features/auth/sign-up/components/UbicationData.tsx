...
const UbicationData = ({ role, onSubmit }: UbicationDataProps) => {
  ...
  const { control, handleSubmit, setValue, watch } = useForm<UbicationFormData>(
    {
        ...
        {role === "client" && (
          <>
            ...
            <View style={styles.addressTypeContainer}>
              <Pressable
                style={[
                  ...
                  addressType === "house" && styles.addressTypeButtonSelected,
                ]}
            ...
            {addressType === "apartment" && (
              <>
                <Text>Piso</Text>
                <CustomInput control={control} name="floor" placeholder="5" />
                <Text>Departamento</Text>
                <CustomInput
                  control={control}
