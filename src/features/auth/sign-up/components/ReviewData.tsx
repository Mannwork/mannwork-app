...
const ReviewData = () => {
  ...
  const fullAddress = ubication_json
    ? `${ubication_json.street || ""}, ${ubication_json.city || ""}, ${
        ubication_json.province || ""
      }`
    : "No especificada";
        ...
        >
          <View className="items-center py-6">
            <View className="relative">
              ...
              >
                <MaterialIcons name="camera-alt" size={20} color="#2D7A3E" />
              </Pressable>
            </View>
          ...
          <View className="w-full mt-2 bg-white rounded-xl shadow-sm p-5 mb-6">
            ...
            <View className="space-y-4 mt-2">
              <InfoRow
                ...
                value={cel_phone || "No especificado"}
              />
              <InfoRow
                icon="briefcase"
                label="Rol"
