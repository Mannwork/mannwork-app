...
const EmptyChatsState = ({ onStartChat, userRole }: EmptyChatsStateProps) => {
    ...
    const getSubtitle = () => {
        return userRole === "client"
            ? "Cuando un profesional te contacte por una solicitud de trabajo, aparecerá aquí tu conversación"
            : "Cuando contactes a un cliente para un trabajo, aparecerá aquí la conversación";
    };
