...
import { Animated, Keyboard, SafeAreaView, Text, TouchableWithoutFeedback, View } from 'react-native';
      ...
      <SafeAreaView className="flex-1 bg-green-mannwork">
        ...
        >
          <View className="flex-1 gap-y-2">
            ...
            <SignInWith strategy="oauth_facebook" variant="outline" />
            
            <View className="flex-row items-center my-4">
              <View className="flex-1 h-px bg-gray-200" />
              <Text className="px-3 text-gray-400 text-sm">o continúa con</Text>
              <View className="flex-1 h-px bg-gray-200" />
            </View>
          ...
          <View className="mt-8 mb-4">
            <Text className="text-center text-gray-400 text-xs">
              ...
              <Text className="text-green-600 font-medium">Términos de Servicio</Text> y{" "}
              <Text className="text-green-600 font-medium">Política de Privacidad</Text>
            </Text>
          </View>
        </Animated.View>
      </SafeAreaView>
